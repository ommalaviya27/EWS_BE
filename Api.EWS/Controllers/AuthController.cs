...
namespace Api.EWS.Controllers
{
    ...
    public class AuthController(IAuthService authService) : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequest request)
        {
            ...
            return Ok(ResponseHelper.SuccessResponse(response, "Operation completed successfully."));
        }
        ...
        public async Task<IActionResult> RefreshToken([FromBody] RefreshTokenRequest request)
        {
            ...
            return Ok(ResponseHelper.SuccessResponse(response, "Token refreshed successfully."));
        }
        ...
        public async Task<IActionResult> Logout([FromBody] RefreshTokenRequest request)
        {
            ...
            return Ok(ResponseHelper.SuccessResponse<object>(null, "Logged out successfully."));
        }
    }
}